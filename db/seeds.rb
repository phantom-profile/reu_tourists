...
# Witchers
witcher_attrs = [
  {name: 'Geralt', nickname: 'the White Wolf', age: 95, sword: Sword.find(1), location: 'Rivia', school: schools.sample},
  {name: 'Ciri', nickname: 'the Sivlerhead', age: 16, sword: Sword.find(2), location: 'Monastery', school: schools.sample},
  {name: 'Aiden', nickname: 'the Cat', age: 78, sword: Sword.find(3), location: 'South', school: schools.sample},
  {name: 'Berengar', nickname: 'the Winter', age: 88, sword: Sword.find(4), location: 'Khaer-Morchen', school: schools.sample},
  {name: 'Vesemir', nickname: 'the Elder', age: 157, sword: Sword.find(5), location: 'Khaer-Morchen', school: schools.sample}
]
